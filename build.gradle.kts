...
group = "org.tavall"
extra["versionTagPrefix"] = "tavall-logging"
...
publishing {
    ...
    repositories {
        ...
        if (token.isPresent) {
            maven {
                name = "GitHubPackages"
                url = uri("https://maven.pkg.github.com/TavallStudios/tavall-logging")
                credentials {
