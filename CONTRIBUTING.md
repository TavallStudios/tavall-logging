# Contributing to tavall-logging

This repository is the canonical standalone source of truth for `tavall-logging`.

## Development workflow

1. Clone or fetch this repository:
   ```bash
   git clone https://github.com/TavallStudios/tavall-logging.git
   ```
